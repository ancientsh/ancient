...
type PrettyDateSize = 'xs' | 'sm' | 'base' | 'lg' | 'xl' | '2xl'
...
const sizeClasses: Record<PrettyDateSize, string> = {
  xs: 'text-xs',
  sm: 'text-sm',
  base: 'text-base',
  lg: 'text-lg',
...
function formatDuration(milliseconds: number, showSeconds = false): string {
  ...
  if (remainingMinutes > 0 || hours > 0 || days > 0) parts.push(`${remainingMinutes}m`)
